        ...
        <div id="kc-terms-text" onclick="javscript:document.getElementById('kc-accept').focus()">
            <div>
                ...
                <ul>
                    ...
                    <li>NOTICE: There is the potential that information presented and exported from the Project Blue Mission Environment
                        contains FOUO or Controlled Unclassified Information (CUI). It is the responsibility of all
                        users to ensure information extracted from Project Blue Mission Environment is appropriately marked and properly
                    ...
                    <li>As a user of this IS, you may have access to USG’s Project Blue Mission Environment. Third-party software publishers
                        ...
                        Third Party Software available to users of Project Blue Mission Environment. In the event you use the IS
                        (including Project Blue Mission Environment) to access, download, execute, display and/or otherwise use (collectively, “Use”)
                        such Third-Party Software, by Using the IS (including Project Blue Mission Environment) and/or such Third-Party Software,
                    ...
                    <li>You are approved to process up to and including unclassified naval nuclear propulsion information 
                        (U-NNPI) on this system.
                    </li>
                    <li>U-NNPI is not for release to foreign nationals (NOFORN) and has special handling requirements. 
                        U-NNPI is subject to special export controls, and each transmittal to foreign governments or 
                        foreign nationals may be made only with the approval of the Director, Naval Nuclear Propulsion Program (CNO (N00N)). 
                        It is your responsibility to protect U-NNPI from disclosure to individuals without a need-to-know.
                    </li>
                    <li>You are not approved to process classified information on this system.
                    </li>
                </ul>
            </div>
        </div>
